...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { description: @complaint.description, resident_id: @complaint.resident_id, title: @complaint.title } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { description: @complaint.description, resident_id: @complaint.resident_id, title: @complaint.title } }
