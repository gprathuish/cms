...
class ColoniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colony" do
    assert_difference('Colony.count') do
      post colonies_url, params: { colony: { contact_id: @colony.contact_id, description: @colony.description, name: @colony.name } }
    end
  ...
  test "should update colony" do
    patch colony_url(@colony), params: { colony: { contact_id: @colony.contact_id, description: @colony.description, name: @colony.name } }
